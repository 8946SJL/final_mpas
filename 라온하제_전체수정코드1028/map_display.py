...
def continue_recommendation():
    ...
    if similarity_score < 50:
        ...
        # 가장 유사한 시설 찾기
        matching_facilities = filtered_df[filtered_df['combined_text'].str.contains(best_match_keyword)]
        
        if not matching_facilities.empty:
            recommended_facility = matching_facilities.iloc[0]  # 가장 첫 번째 시설 선택
